  ...
  <Link to="/"><Navbar.Brand style={{color: "white"}}>React-Bootstrap</Navbar.Brand> </Link>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      <Nav className="ms-auto" >
        ...
        <Nav.Link as = {NavLink} to="/register" style={{color: "white", border: "1px solid black", borderRadius: "15px", backgroundColor: "blue"}}><i className="fa fa-user-plus" ></i> <strong>Register</strong> </Nav.Link>
