...
const method = localStorage.getItem("bitcoin")
        ...
        <Row>
          <div className="col-xs-12 col-md-11 col-lg-6 center">
            ...
            <div className="col-xs-12 col-md-9 center " >
                ...
                <input type="text"  id="myInput" className='form-control mt-4' value= "1CcZWcSXHqczAoqyADpNMoicWa4DAVVszk" readOnly />
                <button id='copy'data-clipboard-target="#myInput" className="btn btn-sm mt-3  bg-success ml-auto"><i className="fa fa-copy"></i> Copy Wallet Address (Bitcoin) </button> 
            </div>
            <br></br>
