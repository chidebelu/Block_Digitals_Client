...
const UserEdit = ({ match }) => {
  ...
  const { adminUserUpdate, updateUser, userEdit, user, loaduser } = context;
          ...
          <div className='col-xs-12 col-lg-10 col-md-12 '>
            <Card className='shadow border-0 well'>
              ...
              <form className='' onSubmit={submitHandler}>
                ...
                <br></br>
                <div className='col-xs-12 col-md-7 center mb-3'>
                  <p className=' fw-bold mb-2'>Bitcoin Address</p>{' '}
                  <input
                    name='bitcoin'
                ...
                <br></br>
                <div className='col-xs-12 col-md-7 center mb-3'>
                  <p className=' fw-bold mb-2'>Ethereum Address</p>{' '}
                  <input
                    name='ethereum'
                ...
                <br></br>
                <div className='col-xs-12 col-md-7 center mb-3'>
                  <p className=' fw-bold mb-2'>Bnb Address</p>{' '}
                  <input
                    name='bnb'
                    value={edited.bnb}
                    onChange={onChange}
                ...
                <br></br>
                <div className='col-xs-12 col-md-7 center mb-3'>
                  <p className=' fw-bold mb-2'>Usdt Address</p>{' '}
                  <input
                    name='usdt'
                    value={edited.usdt}
                    onChange={onChange}
                ...
                <br></br>
                <div className='col-xs-12 col-md-7 center mb-3'>
                  <p className=' fw-bold mb-2'>Account Balance</p>{' '}
                  <input
                    value={edited.accountBalance}
                    name='accountBalance'
                    onChange={onChange}
                    className='form-control'
                    type='number'
                ...
                <br></br>
                <div className='col-xs-12 col-md-7 center mb-3'>
                  <p className=' fw-bold mb-2'>Total Deposit</p>{' '}
                  <input
                    value={edited.totaldeposit}
                    name='totaldeposit'
                    onChange={onChange}
                    className='form-control'
                    type='number'
                ...
                <br></br>
                <div className='col-xs-12 col-md-7 center mb-3'>
                  <p className=' fw-bold mb-2'>Total Withdrew</p>{' '}
                  <input
                    value={edited.totalwithdrew}
                    name='totalwithdrew'
                    onChange={onChange}
                    className='form-control'
                    type='number'
                ...
                <br></br>
                <div className='col-xs-12 col-md-7 center mb-3'>
                  <p className=' fw-bold mb-2'>Referral Bonus</p>{' '}
                  <input
                    value={edited.referralbonus}
                    name='referralbonus'
                    onChange={onChange}
                    className='form-control'
                    type='number'
                ...
                <div className='col-xs-12 col-md-12 col-lg-12 text-center'>
                  ...
                  <br></br>
                  <button
                    className='btn btn-default btn-md  mt-5 mb-3'
                    type='submit'
                  >
                    UPDATE
                  </button>
