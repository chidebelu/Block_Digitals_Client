        ...
        <Row>
          <div className="col-xs-12 col-xs-12 col-md-12 col-lg-12 center">
            <Card className="shadow border-0 well ">
              <h2 className="text-center fw-bold mt-3 mb-5">YOUR WITHDRAWAL REQUESTS</h2>
              {
                getUserWithdrawalList.length===0 
                ? (<badge className=" bg-success text-center mx-auto w-75 mb-5 mt-3" style={{height:"60px"}}><p className="mt-2">YOU HAVE NOT MADE ANY WITHDRAWALS</p></badge>)
                : (
                  <table className="striped bordered hover responsive table-sm mb-5 text-center  " variant="dark">
