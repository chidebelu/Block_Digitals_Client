...
const AdminWithdrawalRequests = () => {
    ...
    const { loading, error, adminGetAllWithdrawalsLists, deleteUserWithdrawalRequest, adminGetAllWithdrawalsList} = context
  ...
  return ( <>
      ...
      <Navbar/>
    <h1 style={{textAlign:"center"}} className="mt-3">List of all User Withdrawal Requests</h1> <br></br>
