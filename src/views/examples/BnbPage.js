...
const method = localStorage.getItem("Bnb")
        ...
        <Row>
          <div className="col-xs-12 col-md-11 col-lg-6 center">
            ...
            <div className="col-xs-12 col-md-9 center " >
                ...
                <button id='copy'data-clipboard-target="#myInput" className="btn btn-sm mt-3  bg-success ml-auto"><i className="fa fa-copy"></i> Copy Wallet Address (Bnb) </button> 
            </div>
            <br></br>
