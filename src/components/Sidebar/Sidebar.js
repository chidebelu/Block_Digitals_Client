        ...
        <Nav className="align-items-center d-md-none">
          <UncontrolledDropdown nav>
            ...
            <DropdownMenu
              ...
              right
            >
             <a href="/faq"> <DropdownItem>Frequently Asked Questions</DropdownItem> </a>
             <a href="/support"> <DropdownItem>Message Support</DropdownItem> </a>
              <DropdownItem divider />
              <a href="/aboutus"> <DropdownItem>Our Company</DropdownItem> </a>
            </DropdownMenu>
          </UncontrolledDropdown>
          <UncontrolledDropdown nav>
            <DropdownToggle nav>
            ...
            <DropdownMenu className="dropdown-menu-arrow" right>
              ...
              <DropdownItem to="/withdrawals" tag={Link}>
